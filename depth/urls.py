...
urlpatterns = patterns('',
    ...
    (r'^tool/config/(?P<object_id>[\d\-a-f]+)/$', 'django.views.generic.list_detail.object_detail', {'extra_context': {'navigation_template': 'tool_config_menu.html'}, 'queryset': Tool.objects.all(), 'template_name': 'tool_config_form.html' }, 'tool_config'),
    (r'^tool/config/(?P<object_id>[\d\-a-f]+)/general/$', 'tdsurface.depth.views.tool_general_config', {'extra_context': {'subtitle':'Update Tool', 'navigation_template': 'tool_config_menu.html'}, }, 'tool_general_config'),
    (r'^tool/config/(?P<object_id>[\d\-a-f]+)/motor/$', 'tdsurface.depth.views.tool_motor_config', {'extra_context': {'subtitle':'Tool Motorl Configuration', 'navigation_template': 'tool_config_menu.html'}, }, 'tool_motor_config'),
